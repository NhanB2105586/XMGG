...
<div class="sidebar" id="mySidebar">
    <div class="side-header">
        <img src="/images/admin/logo.png" width="80" height="80" alt="Swiss Collection">
    ...
    <a href="#category"><i class="fa fa-th-large"></i> Sản phẩm</a>
    <a href="#sizes"><i class="fa fa-th"></i> Danh mục</a>
