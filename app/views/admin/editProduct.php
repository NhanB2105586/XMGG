...
<body>
    ...
    <div class="container mt-3" id="main-content">
        ...
        <form action="/admin/editProducts" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    <div style="display: inline-block; margin-right: 10px; text-align: center;">
                        <img src="/images/upload/<?= htmlspecialchars($image['image_url']) ?>" alt="Product Image" style="width: 100px; height: auto;">
                        <div>
                            <label>
            ...
            <div class="form-group">
                <label for="images">Hình Ảnh Mới</label>
                <input type="file" class="form-control" id="images" name="images[]" multiple accept="image/*">
                <div id="preview-images" class="mt-2"></div>
            </div>
            <button href="" type="submit" class="btn btn-primary btn-block mt-3">Cập Nhật Sản Phẩm</button>
        </form>
    </div>
    <?php
