        ...
        <form action="/admin/addProduct" method="POST" enctype="multipart/form-data" class="modern-form">
            <div class="row">
                    ...
                    <div class="card modern-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control modern-input" name="product_name" required>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control modern-input" name="old_price" step="0.01" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control modern-textarea" name="description" rows="4" required></textarea>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card modern-card">
                        <div class="card-header bg-gradient">
                            <h5><i class="fas fa-images"></i> Hình Ảnh</h5>
                        </div>
                        <div class="card-body">
                            <div class="upload-zone" id="uploadZone">
                                <div class="upload-content">
                                    ...
                                    <input type="file" class="file-input" id="images" name="images[]" multiple accept="image/*" required>
