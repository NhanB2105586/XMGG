        ...
        <div class="top-banner">
            <div class="banner-text">
                ...
                <div class="breadcrumb">
                    <a href="/">Trang chủ</a>&nbsp;/&nbsp;<strong class="current-page"><?= htmlspecialchars($category['category_name']) ?></strong>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-3 mt-3">
            <?php if (empty($products)): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Chúng tôi sẽ cập nhật sản phẩm sớm nhất có thể!</p>
                </div>
            <?php else: ?>
