...
try {
    ...
    $category = $categoryModel->getCategoryBySlug("khang-1");
        ...
        <div class="top-banner">
            <div class="banner-text">
                ...
                <div class="breadcrumb">
                    <a href="/">Trang chủ</a>&nbsp;</a>/&nbsp<a href="/category/khang-1"> <strong class="current-page">Khang</strong></a>
                </div>
            </div>
        </div>
            ...
            <div class="special-list row g-0 ">
                ...
                <?php else: ?>
                    <div class="col-12 text-center py-5">
                        <h4>Không có sản phẩm Khang nào</h4>
