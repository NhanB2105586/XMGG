...
<body>
    ...
    <div class="container-fluid main-content mt-3">
        ...
        <div class="top-banner-sp">
            <div class="banner-text">
                Test Controller 2025-08-21 10:13:13
                <div class="breadcrumb">
                    <a href="/">Trang chủ</a>&nbsp;/&nbsp;<a href="/sanpham">Sản phẩm</a>&nbsp;/&nbsp;<strong class="current-page">Test Controller 2025-08-21 10:13:13</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            loadProductsByCategory("test-controller-2025-08-21-101313-1");
        });
