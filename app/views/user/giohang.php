                            ...
                            <tbody>
                                ...
                                <?php foreach ($cartItems as $item) : ?>
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <a href="/cart/remove/<?php echo $item['product_id']; ?>"
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush ">
                            ...
                            <li class="list-group-item">
                                <div
                                    class="input-group">
                                    <input type="text" name="coupon_code" class="form-control " style="height: 35px; font-size: 13px;"
                                        placeholder="Mã giảm giá">
                                    <button class="btn btn-primary">
                                        <i class="fas fa-tag"></i>&nbsp;Sử dụng
                                    </button>
                                </div>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <li class="list-group-item">
                                ...
                                <p style="font-size: 12px;">Đối với những sản phẩm có sẵn tại khu vực, Quý Nhân sẽ giao hàng trong vòng 2-7 ngày.</p>
                                <p style="font-size: 12px;"> Đối với những sản phẩm không có sẵn, thời gian giao hàng sẽ được nhân viên Quý Nhân thông báo đến quý khách.</p>
                        ...
                        <div class="text-center">
                            ...
                            ?>
                                <a href="#" class="btn btn-dark w-100 mb-2" onclick="document.getElementById('placeOrderForm').submit();">
