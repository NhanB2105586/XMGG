...
?>
<link href="/css/stylephongngu.css" rel="stylesheet">
        ...
        <div class="top-banner">
            <div class="banner-text">
                ...
                <div class="breadcrumb">
                    <a href="/">Trang chủ</a>&nbsp;/&nbsp;<a href="/phongngu.php"> <strong class="current-page">Phòng ngủ</strong></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="category-sidebar p-4 bg-light border rounded shadow-sm">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item bg-transparent border-0"><a href="/sanpham/sofa.php" class="text-decoration-none text-dark">Giường ngủ</a></li>
                        <li class="list-group-item bg-transparent border-0"><a href="#" class="text-decoration-none text-dark">Tủ áo</a></li>
                        <li class="list-group-item bg-transparent border-0"><a href="#" class="text-decoration-none text-dark">Tủ hộc kéo</a></li>
                        <li class="list-group-item bg-transparent border-0"><a href="#" class="text-decoration-none text-dark">Bàn trang điểm</a></li>
                        <li class="list-group-item bg-transparent border-0"><a href="#" class="text-decoration-none text-dark">Nệm</a></li>
                        <li class="list-group-item bg-transparent border-0"><a href="#" class="text-decoration-none text-dark">Gối</a></li>
                        <li class="list-group-item bg-transparent border-0"><a href="#" class="text-decoration-none text-dark">Chăn (mền)</a></li>
                    </ul>
                </div>
            </div>
